...
public class MainActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        enablesettings = (Button)findViewById(R.id.enablesettings);
        disablesettings = (Button)findViewById(R.id.disablesettings);
        ...
        mRFConfigButtonText = (TextView) findViewById(R.id.rfconf_text);
        ...
        enablesettings.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (pass.getText().toString().equals("password")){
                    mRFConfigButton.setVisibility(View.VISIBLE);
                    mRFConfigButtonText.setVisibility(View.VISIBLE);
                }
                else {
        ...
        disablesettings.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {

                    mRFConfigButton.setVisibility(View.GONE);
                    mRFConfigButtonText.setVisibility(View.GONE);
                    pass.setText("");
            }
        });
