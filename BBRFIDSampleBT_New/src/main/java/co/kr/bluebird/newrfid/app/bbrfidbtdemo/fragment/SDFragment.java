    ...
    public void handleMessage(Message m) {
        ...
        case SDConsts.Msg.SBMsg:
            if (m.arg1 == SDConsts.SBCmdMsg.BARCODE_TRIGGER_PRESSED_SLED)
                ...
                StringBuilder readData2 = new StringBuilder();
                if (D) Log.d(TAG, "SB_MSG_BARCODE_READ");
                if (m.arg2 == SDConsts.SBResult.SUCCESS)
                    readData2.append(" " + "SB_MSG_BARCODE_READ");
                else if (m.arg2 == SDConsts.SBResult.ACCESS_TIMEOUT)
                    readData2.append(" " + "SB_MSG_BARCODE_ACCESS_TIMEOUT");
                if (m.obj != null  && m.obj instanceof String) {
                    readData2.append("\n  " + (String)m.obj);
                    mMessageTextView.setText(" " + (String)m.obj);
                }
                mMessageTextView.setText(" " + readData2.toString());
            }
            break;
