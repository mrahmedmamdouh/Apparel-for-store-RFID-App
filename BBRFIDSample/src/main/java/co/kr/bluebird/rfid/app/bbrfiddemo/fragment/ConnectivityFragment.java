    ...
    private void updateConnectStateTextView(boolean b) {
        if (b) {
            ...
            if (mOptionHandler != null)
                mOptionHandler.obtainMessage(ConnectivityFragment.MSG_OPTION_CONNECTED).sendToTarget();
        } else {
            mConnectStateTextView.setText(R.string.disconnected_str);
            if (mOptionHandler != null)
                mOptionHandler.obtainMessage(ConnectivityFragment.MSG_OPTION_DISCONNECTED).sendToTarget();
        }
    }
